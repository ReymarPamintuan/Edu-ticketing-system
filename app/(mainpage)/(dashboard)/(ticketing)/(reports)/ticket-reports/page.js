    ...
    <>
      <div className="mb-[20px]">
        <div className="flex justify-between items-center mb-[35px] mt-[10px]">
          <div><h4 className="font-[600]">Ticketing Reports</h4></div>       
          <div>
        ...
        <div className="grid grid-cols-3 gap-7">
          <div className="px-[20px] py-[20px] bg-white rounded-[5px]">
            <div className="font-[600]"><label>Status</label></div>
            <div><Pie /></div>
          </div>
          <div className="col-span-2 px-[20px] py-[20px] bg-white rounded-[5px]">
            <div className="font-[600]"><label>Categories</label></div>
            <Column />
          </div>
          <div className="col-span-3 px-[20px] py-[20px] bg-white rounded-[5px]">
            <div className="font-[600]"><label>Tickets Per Member</label></div>
            <BasicBar />
          </div>
        </div>
      </div>
