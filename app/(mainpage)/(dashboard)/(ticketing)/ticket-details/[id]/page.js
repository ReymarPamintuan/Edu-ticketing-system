...
// }
  ...
  export default function Page({ params }) {
    ...
    const items = [
      {
        title: <div>Priority: <span className="text-red-600 font-[600]">High</span></div>,
        content:
      ...
      {
        title: <div>Status: <span className="text-blue-600 font-[600]">In Progress</span></div>,
        content:
          <div className="space-x-3 flex">
            <Select className="cursor-pointer" options={[" -select ", "High", "Medium", "Low", "Lorum"]}/>
            <Button className="bg-green-600 px-[15px] py-[6px] text-white" href="#"> Save </Button>
      ...
      {
        title: <div>Category: <span className="font-[600]">Condition-Based</span></div>,
        content:
          <div className="space-x-3 flex">
            <Select className="cursor-pointer" options={[" -select ", "High", "Medium", "Low", "Lorum"]}/>
            <Button className="bg-green-600 px-[15px] py-[6px] text-white" href="#"> Save </Button>
      ...
      {
        title: <div>Assigned: <span className="font-[600]">Josh Aulozzi</span></div>,
        content:
          <div className="space-x-3 flex">
            <Select className="cursor-pointer" options={[" -select ", "High", "Medium", "Low", "Lorum"]}/>
            <Button className="bg-green-600 px-[15px] py-[6px] text-white" href="#"> Save </Button>
      ...
      {
        title: <div>Property: <span className="font-[600]">Akins high School</span></div>,
        content:
          <div className="space-x-3 flex">
            <Select className="cursor-pointer" options={[" -select ", "High", "Medium", "Low", "Lorum"]}/>
            <Button className="bg-green-600 px-[15px] py-[6px] text-white" href="#"> Save </Button>
      ...
      {
        title: <div>Location: <span className="font-[600]">ENtrance, Building B</span></div>,
        content:
          <div className="space-x-3 flex">
            <Select className="cursor-pointer" options={[" -select ", "High", "Medium", "Low", "Lorum"]}/>
            <Button className="bg-green-600 px-[15px] py-[6px] text-white" href="#"> Save </Button>
      ...
      <>
        <div className="mb-[20px]">
          <div className="flex justify-between items-center mb-[35px] mt-[10px]">
            <div><h4 className="font-[600]">Ticket Details</h4></div>       
            <div>
          ...
          <div className="grid grid-cols-3 gap-7">
            <div className="col-span-2 px-[20px] py-[20px] bg-white rounded-[5px]">
              ...
              <p className="text-[18px] mb-[15px]">Seams the window broke at the front door of building B. Need to order replacement and install.</p>
              ...
              <div className="flex justify-end items-center">
                <Link href="#" className="px-9 py-1 bg-[#0665d0] rounded-[3px] text-[13px] text-white">Save</Link>
              </div>
