...
const InvoiceChanged3Page = ({ advancedTable }) => {
                    ...
                    >
                      {headerGroup.headers.map((column) => (
                        <th
                          ...
                          scope="col"
                          className=" table-th font-[600] text-[16px] capitalize"
                          key={`ex-th-${column.id}`}
                        >
                      ...
                      <tr {...row.getRowProps()} key={`ex-tr2-${row.id}`}>
                        {row.cells.map((cell) => {
                          return (
                            <td
                              {...cell.getCellProps()}
                              className="table-td py-3 border border-slate-300"
...
export default InvoiceChanged3Page;
